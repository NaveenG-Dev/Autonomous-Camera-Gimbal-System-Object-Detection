...
extern "C" bool PCA9685::openPCA9685()
{
...
extern "C" void PCA9685::closePCA9685()
{
    if (kI2CFileDescriptor > 0) {
...
extern "C" void PCA9685::setPWMFrequency ( float frequency ) {
...
extern "C" void PCA9685::setPWM ( int channel, int onValue, int offValue) {
...
extern "C" void PCA9685::setAllPWM (int onValue, int offValue) {
...
extern "C" int PCA9685::readByte(int readRegister)
{
...
extern "C" int PCA9685::writeByte(int writeRegister, int writeValue)
{   // For debugging:
